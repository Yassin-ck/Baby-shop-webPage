...
const Logout = () => {
    const {login,setLogin,profileName,setProfileName} = useContext(myContext)
   ...
   const clickHandler=()=>{
    ...
    if(name ==  Username[Username.length-1].toString()&& pass == Password[Password.length-1].toString()){
navigate('/signup')
setProfileName(null)
   }else{
